package dev.supersam.devassist.features
...
import dev.supersam.devassist.api.DebugOverlay
import dev.supersam.devassist.initialization.CrashLogManager
...
internal object DefaultActions {
    ...
    private class ExportSharedPreferencesAction : ExportFileAction("prefs") {
        ...
        override fun getExportSubdirectory(context: Context): File =
            File(context.filesDir, "devassist_export/shared_prefs")
    ...
    private class ExportDatabaseAction : ExportFileAction("db") {
        ...
        override fun getExportSubdirectory(context: Context): File {
            ...
            val exportDir = File(context.filesDir, "devassist_export/databases")
            exportDir.mkdirs()
            return exportDir
