package dev.supersam.devassist.core // Ensure this matches your package
...
import dev.supersam.devassist.R
import dev.supersam.devassist.api.DebugOverlayRegistry
import dev.supersam.devassist.ui.DebugOverlayScreen
...
internal object DebugOverlayController : Application.ActivityLifecycleCallbacks {
    ...
    private class TouchInterceptorCallback(
        ...
        override fun dispatchKeyEvent(event: android.view.KeyEvent?): Boolean = originalCallback.dispatchKeyEvent(event)
        override fun dispatchKeyShortcutEvent(event: android.view.KeyEvent?): Boolean = originalCallback.dispatchKeyShortcutEvent(event)
        ...
        override fun dispatchPopulateAccessibilityEvent(event: android.view.accessibility.AccessibilityEvent?): Boolean = originalCallback.dispatchPopulateAccessibilityEvent(event)
        override fun onCreatePanelView(featureId: Int): android.view.View? = originalCallback.onCreatePanelView(featureId)
        override fun onCreatePanelMenu(featureId: Int, menu: android.view.Menu): Boolean = originalCallback.onCreatePanelMenu(featureId, menu)
        override fun onPreparePanel(featureId: Int, view: android.view.View?, menu: android.view.Menu): Boolean = originalCallback.onPreparePanel(featureId, view, menu)
        override fun onMenuOpened(featureId: Int, menu: android.view.Menu): Boolean = originalCallback.onMenuOpened(featureId, menu)
        override fun onMenuItemSelected(featureId: Int, item: android.view.MenuItem): Boolean = originalCallback.onMenuItemSelected(featureId, item)
        override fun onWindowAttributesChanged(attrs: android.view.WindowManager.LayoutParams?) = originalCallback.onWindowAttributesChanged(attrs)
        ...
        override fun onPanelClosed(featureId: Int, menu: android.view.Menu) = originalCallback.onPanelClosed(featureId, menu)
        override fun onSearchRequested(): Boolean = originalCallback.onSearchRequested()
        override fun onSearchRequested(searchEvent: android.view.SearchEvent?): Boolean = originalCallback.onSearchRequested(searchEvent)
        override fun onWindowStartingActionMode(callback: android.view.ActionMode.Callback?): android.view.ActionMode? = originalCallback.onWindowStartingActionMode(callback)
        override fun onWindowStartingActionMode(callback: android.view.ActionMode.Callback?, type: Int): android.view.ActionMode? = originalCallback.onWindowStartingActionMode(callback, type)
        override fun onActionModeStarted(mode: android.view.ActionMode?) = originalCallback.onActionModeStarted(mode)
        override fun onActionModeFinished(mode: android.view.ActionMode?) = originalCallback.onActionModeFinished(mode)
    }
}